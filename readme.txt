...
1. Upload `stack-overflow-activity-feed.php` directory to the `/wp-content/plugins/` directory
1. Activate the plugin through the 'Plugins' menu in WordPress
1. Drag and drop the *Stack Overflow Activity Feed Widget* to any of your sidebars
1. Configure the widget options

== Screenshots ==

1. Widget configuration
2. Sample widget display on site
3. Widget display on my site
